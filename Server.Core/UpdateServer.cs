...
namespace Server.Core
{
    public class UpdateServer: IUpdateServer
    {
        ...
        public byte[] GetFilePart(string path, int id, out bool isLast) => DataContainer.Default.GetFilePart(path, id, out isLast);
        public void Update(string token) => DataContainer.Default.Update(token);
